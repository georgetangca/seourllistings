    function get_sidebar_filter() { //get filter list from form
   ...
   function set_sidebar_filter_status(){
   ...
   $(document).ready(function(){
    ...
    $('#search_form input[type=text]').bind('keypress', function(e) {
      if(e.which == 13) {
        e.preventDefault();
        loadListings(sf);
      }
